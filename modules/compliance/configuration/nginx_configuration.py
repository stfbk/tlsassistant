...
class NginxConfiguration(ConfigurationMaker):
    ...
    def _write_to_file(self):
        ...
        with open(self._config_output, "w") as f:
            f.write("# This file has been automatically generated by TLSAssistant (https://github.com/stfbk/tlsassistant).\n\n" + nginx_build(self._template["config"][0]["parsed"], header=True))
