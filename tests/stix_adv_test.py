...
hostnames_analysis.build_and_save(modules=modules,hostnames_or_paths=hosts,path="out.json")
modules_analysis.build_and_save(modules=modules,hostnames_or_paths=hosts,path="out_modules.json")
